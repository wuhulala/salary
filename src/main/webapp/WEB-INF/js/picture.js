    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(var i in info){
                ...
                var str = "<div  class='col-sm-3 ' onmouseenter='showDes(this)' onmouseleave='hideDes(this)'>" +
...
function showDes(data){
    ...
    $(data).children('.pic-info').animate({"width":tongbao.width(),"height":tongbao.height()*0.5});
}
